...
* [fft2.sage](https://codeberg.org/PatrickM123/darkfi-jailbroken/src/branch/linear-master/script/research/zk/fft/fft2.sage):
  implementation using vandermonde matrices illustrating the theory section below.
* [fft3.sage](https://codeberg.org/PatrickM123/darkfi-jailbroken/src/branch/linear-master/script/research/zk/fft/fft3.sage):
  simple example with $n = 4$ showing 3 steps of the algorithm.
* [fft4.sage](https://codeberg.org/PatrickM123/darkfi-jailbroken/src/branch/linear-master/script/research/zk/fft/fft4.sage):
...
Implementation of this algorithm is available in [fft4.sage](https://codeberg.org/PatrickM123/darkfi-jailbroken/src/branch/linear-master/script/research/zk/fft/fft4.sage).
