...
* zkas: the programming language in which you can write zk circuits
	* [zkas compiler](https://codeberg.org/PatrickM123/darkwow/src/branch/linear-master/src/zkas)
        * [An example circuit written in zkas](https://codeberg.org/PatrickM123/darkwow/src/branch/linear-master/example/simple.zk)
* zkvm: the virtual machine in which zkas circuit binary is run
	* it runs during proof generation
		* [Rust example](https://codeberg.org/PatrickM123/darkwow/src/branch/linear-master/tests/zkvm_opcodes.rs)
		* [Python example](https://codeberg.org/PatrickM123/darkwow/src/branch/linear-master/bin/zkrunner/zkrunner.py#L141-L160)
* zkrunner: a Python script which allows you, instead of providing
  ...
  you provide circuit, witness
	* [Example](https://codeberg.org/PatrickM123/darkwow/src/branch/linear-master/bin/zkrunner/zkrunner.py#L180)
