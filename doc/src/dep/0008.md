...
In DarkWow, spending a commitment requires a Merkle inclusion proof against
...
the intermediate commitment hasn't been inserted into the global tree yet.
...
Intermediate commitments must still emit nullifiers. The verifier checks:
...
global Merkle tree. Intermediate commitments that were both created and
