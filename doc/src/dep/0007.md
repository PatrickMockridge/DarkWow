...
seeds = [
    "tcp+tls://lilith0.darkwow.org:9600",
    "tcp+tls://lilith1.darkwow.org:9600",
...
seeds = [
    #"socks5+tls://127.0.0.1:9050/lilith0.darkwow.org:9601",
    #"socks5+tls://127.0.0.1:1080/lilith1.darkwow.org:9601"
]
...
seeds = [
    "tor+tls://lilith0.darkwow.org:9600",
    "tor+tls://lilith1.darkwow.org:9600"
]
...
> **Implementation note**: In the current code (`src/net/settings.rs`), the flat
> fields marked REMOVED above are actually retained alongside the new `profiles`
> HashMap for backward compatibility. During `Settings` construction
> (`settings.rs:453-480`), addresses from both the flat fields and
> profile-specific entries are aggregated. This allows existing config files to
> continue working during the transition to profile-based configuration.
