...
**Development occurs on the `linear-master` branch** — the main development branch with Uncle Merkle consensus.
...
See [Uncle Merkle Consensus](doc/src/arch/consensus/uncle_merkle.md) for the detailed specification.
...
**Branches:**
- `linear-master` — Main development branch (Uncle Merkle consensus, linear blockchain)
- `master-upstream` — Archived upstream overlay-DAG code (preserved for reference)
...
- [Opcodes Reference](doc/src/arch/zk/opcodes.md) — Opcode soundness with Lean 4 proofs
- [Composability](doc/src/arch/composability.md) — Contract composition patterns
- [Safemath](doc/src/arch/zk/safemath.md) — Legacy ZK arithmetic templates
- [Entropy Module](doc/src/contract/entropy.md) — Provable randomness via block hash
