...
See [Mining Network Architecture](../arch/consensus-coinbase.md#12--mining-network-architecture)
...
PoW fork choice. See [Anchoring Finality Gadget](../arch/caribina.md)
for the full design.
...
The full economic model is documented in [Merge Mining — Mining Competition Model](../arch/merge-mining.md#mining-competition-model).
...
See the [darkwow-testnet README](https://github.com/PatrickMockridge/DarkWow/blob/linear-master/contrib/docker/darkwow-testnet/README.md)
