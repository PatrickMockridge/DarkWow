...
See the [`serial`](https://github.com/PatrickMockridge/DarkWow/blob/linear-master/src/serial/src/lib.rs)
...
[`decoder.rs`](https://github.com/PatrickMockridge/DarkWow/blob/linear-master/src/zkas/decoder.rs)
module.
