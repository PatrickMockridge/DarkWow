...
| [Stablecoin](contracts/stablecoin.md) | Collateralized debt | Monero backing |
...
| [Bearer Bond](../../../src/contract/bearer_bond/src/lib.rs) | Fixed-income instruments | Interest-bearing bonds |
...
- [Contract Inherent Safety](contracts/safety.md) — Design principles for safe contracts, NativeToken/PromissoryNote separation of concerns, and the twelve root causes contract vulnerabilities fall into
