...
|----------|-------|-------|
| **Chain-level** (coinbase detection, fee extraction, supply verification, block validation) | Function selector byte only | `c.data[0]` — checks `0x05` (PoWRewardV1), `0x06` (FeeCollectV1), `0x08` (FeeV3) |
