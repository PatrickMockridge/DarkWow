...
> **Important**: `LessThanOrEqual` (0x55), `IsEqualBase` (0x54), `NotBase` (0x56), `BaseLtStrict` (0x57), and `BaseDiv` (0x58) are **DarkWow additions to the zkVM** — they do not exist in upstream DarkFi. The Lean4 formal verification proofs live in this repository (`proofs/lean/`) and were completed on this fork.
