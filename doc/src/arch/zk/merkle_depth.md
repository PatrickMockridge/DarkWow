...
**See also**:
- [MerkleRoot opcode implementation](https://github.com/PatrickMockridge/DarkWow/blob/linear-master/src/zk/vm.rs) - lines 1012-1050
- [deposit_v1.zk circuit](https://github.com/PatrickMockridge/DarkWow/blob/linear-master/src/contract/bridge/proof/deposit_v1.zk) - Example usage with depth-32 tree
