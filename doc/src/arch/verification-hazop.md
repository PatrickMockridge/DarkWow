...
- **It did not adjudicate every candidate.** `OBL-Z18`'s remaining 56 sites and 13 of `OBL-Z16`'s 15 *(superseded in count only: 27 of the 57 have since been adjudicated in two slices — see `OBL-Z18`. The rule this pass calibrated is unchanged, and the sentence below remains true of this pass.)*
