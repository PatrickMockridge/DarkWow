...
Let's connect `dchatd` up to `JSON-RPC` using DarkWow's [rpc
module](https://codeberg.org/PatrickM123/darkfi-jailbroken/src/branch/linear-master/src/rpc).
...
[jsonrpc.rs](https://codeberg.org/PatrickM123/darkfi-jailbroken/src/branch/linear-master/src/rpc/jsonrpc.rs).
