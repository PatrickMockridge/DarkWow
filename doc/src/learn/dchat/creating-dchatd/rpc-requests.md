...
module](https://github.com/PatrickMockridge/DarkWow/tree/linear-master/src/rpc).
...
[jsonrpc.rs](https://github.com/PatrickMockridge/DarkWow/blob/linear-master/src/rpc/jsonrpc.rs).
