...
This is [start](https://codeberg.org/PatrickM123/darkwow/src/branch/linear-master/src/net/p2p.rs#L126):
...
This is [stop](https://codeberg.org/PatrickM123/darkwow/src/branch/linear-master/src/net/p2p.rs#L164).
