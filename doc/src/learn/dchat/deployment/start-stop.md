...
This is [start](https://github.com/PatrickMockridge/DarkWow/blob/linear-master/src/net/p2p.rs#L126):
...
This is [stop](https://github.com/PatrickMockridge/DarkWow/blob/linear-master/src/net/p2p.rs#L164).
