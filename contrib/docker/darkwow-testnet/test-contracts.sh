...
CONTRACTS=(
    ...
    [baccarat]="$REPO_ROOT/src/contract/baccarat/darkfi_baccarat_contract.wasm"
    [betting_stake]="$REPO_ROOT/src/contract/betting_stake/darkfi_betting_stake_contract.wasm"
    [bridge]="$REPO_ROOT/src/contract/bridge/dwow_bridge_contract.wasm"
    [darkbet_exchange]="$REPO_ROOT/src/contract/darkbet_exchange/darkfi_darkbet_exchange_contract.wasm"
    [darktoshi_dice]="$REPO_ROOT/src/contract/darktoshi_dice/darkfi_darktoshi_dice_contract.wasm"
    ...
    [lottery]="$REPO_ROOT/src/contract/lottery/darkfi_lottery_contract.wasm"
    ...
    [roulette]="$REPO_ROOT/src/contract/roulette/darkfi_roulette_contract.wasm"
