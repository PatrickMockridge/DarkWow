...
GLOBALS: Dict[str, dict] = {
    ...
    "FINALITY_DISABLE_CARIBINA": {"value": "false",  "module": "config.sh"},
    ...
    # --- Internal ---
    "DWW_CONFIG_FILE":     {"value": "<mktemp>",       "module": "config.sh"},
...
module_traps = Module(
    ...
    functions=[
        Function("cleanup_on_exit", "traps",
                 ...
                 reads=["COMPOSE_FILE", "DWW_CONFIG_FILE"], lines=16),
    ],
    top_level=[
        "set -eE -o pipefail",
...
module_config = Module(
    ...
    global_defs=[
        ...
        "FINALITY_MODE", "FINALITY_DISABLE_CARIBINA", "FINALITY_ENABLE_MONERO",
    ...
    functions=[
        ...
        Function("DWW", "config", desc="Run dwow_wallet in Docker. Args passed through.",
                 reads=["DWW_CONFIG_FILE"], calls=["error"], lines=15),
    ],
    top_level=[
        ...
        "DWW_CONFIG_FILE generation (heredoc to mktemp)",
...
module_helpers = Module(
    ...
    functions=[
        ...
        Function("_verify_height_via_rpc", "helpers",
                 desc="Check block height via RPC p2p/height call", lines=6),
    ...
    "phase_05_start": Module(
        ...
        functions=[
            Function("phase_start", "phase_start",
                     ...
                     reads=["MODE", "WALLET_ADDRESS", "FINALITY_MODE", "FINALITY_DISABLE_CARIBINA",
                     ...
                     writes=["MONERO_DATA_DIR", "P2POOL_DATA_DIR", "MONERO_OFFLINE",
                             "MONERO_FIXED_DIFFICULTY", "MERGE_MINING"],
            ...
            Function("phase_join_config", "phase_start",
                     ...
                     reads=["JOIN_TEST_DATA", "CONTAINER_NAME", "NETWORK", "P2P_PORT", "RPC_PORT",
                            ...
                            "FINALITY_DISABLE_CARIBINA", "IMAGE"],
        ...
        functions=[
            ...
            Function("phase_join_fallback", "phase_rpc",
                     ...
                     reads=["JOIN_TEST_DATA", "JOIN_TEST_FALLBACK", "CONTAINER_NAME",
                            ...
                            "STRATUM_PORT", "SEED_ADDR", "MAGIC_BYTES", "FINALITY_MODE",
                            "FINALITY_DISABLE_CARIBINA", "FALLBACK_SEED_PORT", "IMAGE"],
    ...
    "phase_09_blocks": Module(
        ...
        functions=[
            Function("phase_blocks", "phase_blocks",
                     ...
                     reads=["MODE", "NODE0", "NATIVE_NODES", "FINALITY_DISABLE_CARIBINA",
    ...
    "phase_10_wallet_tests": Module(
        ...
        functions=[
            Function("phase_wallet_verify", "phase_wallet_tests",
                     ...
                     calls=["_verify_height_via_rpc", "info", "pass", "fail", "warn"],
