...
database = "~/.local/share/darkfi/darkfid/darkwow-testnet"
threshold = 3
max_forks = 8
skip_sync = false
skip_fees = false
...
hostlist = "/root/.local/share/darkfi/darkfid/darkwow-testnet/hostlist.tsv"
$SEEDS
$PEERS
$EXTERNAL_ADDRS
...
if [ "$HOSTNAME" = "node0" ] || [ "$HOSTNAME" = "node1" ]; then
    ...
    DATADIR="/root/.local/share/darkfi/darkfid/darkwow-testnet"
