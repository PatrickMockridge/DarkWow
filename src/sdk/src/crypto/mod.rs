...
pub mod contract_id;
pub use contract_id::{ContractId, ATTESTATION_CONTRACT_ID, DEPLOYOOOR_CONTRACT_ID, IDENTITY_CONTRACT_ID, MONEY_TOKEN_CONTRACT_ID, NATIVE_TOKEN_CONTRACT_ID, ORACLE_CONTRACT_ID, PROMISSORY_NOTE_CONTRACT_ID};
