...
//! Shared contract primitives for DarkWow smart contracts
//!
//! This module provides common patterns used across all DarkWow contracts:
//!
//! ## The Private Authorization Layer Pattern
//!
//! All privacy-preserving DarkWow contracts follow the same authorization pattern:
//!
//! ```text
//! ┌─────────────────────────────────────────────────────────────────┐
