...
/// [`stablecoin_model::MintStableParams`] python binding.
#[pyclass]
pub struct StablecoinMintStableParamsV1(stablecoin_model::MintStableParams);
impl_py_methods!(StablecoinMintStableParamsV1);

impl FunctionParams for stablecoin_model::MintStableParams {
