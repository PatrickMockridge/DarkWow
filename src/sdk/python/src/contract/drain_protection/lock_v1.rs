...
/// [`drain_protection_model::LockParamsV1`] python binding.
#[pyclass]
pub struct DrainProtectionLockParamsV1(drain_protection_model::LockParamsV1);
impl_py_methods!(DrainProtectionLockParamsV1);

impl FunctionParams for drain_protection_model::LockParamsV1 {
