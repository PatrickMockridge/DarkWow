...
/// [`drain_protection_model::ExecuteParamsV1`] python binding.
#[pyclass]
pub struct DrainProtectionExecuteParamsV1(drain_protection_model::ExecuteParamsV1);
impl_py_methods!(DrainProtectionExecuteParamsV1);

impl FunctionParams for drain_protection_model::ExecuteParamsV1 {
