...
/// [`drain_protection_model::UnlockParamsV1`] python binding.
#[pyclass]
pub struct DrainProtectionUnlockParamsV1(drain_protection_model::UnlockParamsV1);
impl_py_methods!(DrainProtectionUnlockParamsV1);

impl FunctionParams for drain_protection_model::UnlockParamsV1 {
