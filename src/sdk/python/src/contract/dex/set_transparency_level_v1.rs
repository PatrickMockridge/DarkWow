...
/// [`dex_model::SetTransparencyLevelParams`] python binding.
#[pyclass]
pub struct DexSetTransparencyLevelParamsV1(dex_model::SetTransparencyLevelParams);
impl_py_methods!(DexSetTransparencyLevelParamsV1);

impl FunctionParams for dex_model::SetTransparencyLevelParams {
    ...
    fn fmt_pretty(&self, out: &mut String, depth: usize) -> PyResult<()> {
        ...
        writeln!(out, "{prefix}level: {:?}", self.level).unwrap();
