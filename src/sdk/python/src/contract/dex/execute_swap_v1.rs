...
/// [`dex_model::ExecuteSwapParams`] python binding.
#[pyclass]
pub struct DexExecuteSwapParamsV1(dex_model::ExecuteSwapParams);
impl_py_methods!(DexExecuteSwapParamsV1);

impl FunctionParams for dex_model::ExecuteSwapParams {
