...
/// [`labor_market_model::CreateJobWithCapabilityParamsV1`] python binding.
#[pyclass]
pub struct LaborMarketCreateJobWithCapabilityParamsV1(
    labor_market_model::CreateJobWithCapabilityParamsV1,
);
impl_py_methods!(LaborMarketCreateJobWithCapabilityParamsV1);

impl FunctionParams for labor_market_model::CreateJobWithCapabilityParamsV1 {
