...
/// [`labor_market_model::CancelJobParamsV1`] python binding.
#[pyclass]
pub struct LaborMarketCancelParamsV1(labor_market_model::CancelJobParamsV1);
impl_py_methods!(LaborMarketCancelParamsV1);

impl FunctionParams for labor_market_model::CancelJobParamsV1 {
