...
/// [`labor_market_model::CreateJobWithMilestonesAndCapabilityParamsV1`] python binding.
#[pyclass]
pub struct LaborMarketCreateJobWithMilestonesAndCapabilityParamsV1(
    labor_market_model::CreateJobWithMilestonesAndCapabilityParamsV1,
);
impl_py_methods!(LaborMarketCreateJobWithMilestonesAndCapabilityParamsV1);

impl FunctionParams for labor_market_model::CreateJobWithMilestonesAndCapabilityParamsV1 {
    fn to_pydict(&self, py: Python) -> PyResult<Py<PyDict>> {
        ...
        dict.set_item("required_capability_id", format!("{:?}", self.required_capability_id))?;
    ...
    fn fmt_pretty(&self, out: &mut String, depth: usize) -> PyResult<()> {
        ...
        writeln!(out, "{prefix}required_capability_id: {:?}", self.required_capability_id).unwrap();
