...
/// [`labor_market_model::DisputeParamsV1`] python binding.
#[pyclass]
pub struct LaborMarketDisputeParamsV1(labor_market_model::DisputeParamsV1);
impl_py_methods!(LaborMarketDisputeParamsV1);

impl FunctionParams for labor_market_model::DisputeParamsV1 {
