...
/// [`labor_market_model::CreateJobParamsV1`] python binding.
#[pyclass]
pub struct LaborMarketCreateJobParamsV1(labor_market_model::CreateJobParamsV1);
impl_py_methods!(LaborMarketCreateJobParamsV1);

impl FunctionParams for labor_market_model::CreateJobParamsV1 {
