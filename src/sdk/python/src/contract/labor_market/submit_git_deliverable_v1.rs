...
/// [`labor_market_model::SubmitGitDeliverableParamsV1`] python binding.
#[pyclass]
pub struct LaborMarketSubmitGitDeliverableParamsV1(labor_market_model::SubmitGitDeliverableParamsV1);
impl_py_methods!(LaborMarketSubmitGitDeliverableParamsV1);

impl FunctionParams for labor_market_model::SubmitGitDeliverableParamsV1 {
