...
/// [`labor_market_model::SubmitMilestoneDeliverableParamsV1`] python binding.
#[pyclass]
pub struct LaborMarketSubmitMilestoneParamsV1(labor_market_model::SubmitMilestoneDeliverableParamsV1);
impl_py_methods!(LaborMarketSubmitMilestoneParamsV1);

impl FunctionParams for labor_market_model::SubmitMilestoneDeliverableParamsV1 {
