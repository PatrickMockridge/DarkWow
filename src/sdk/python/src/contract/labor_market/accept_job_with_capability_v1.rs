...
/// [`labor_market_model::AcceptJobWithCapabilityParamsV1`] python binding.
#[pyclass]
pub struct LaborMarketAcceptJobWithCapabilityParamsV1(
    labor_market_model::AcceptJobWithCapabilityParamsV1,
);
impl_py_methods!(LaborMarketAcceptJobWithCapabilityParamsV1);

impl FunctionParams for labor_market_model::AcceptJobWithCapabilityParamsV1 {
