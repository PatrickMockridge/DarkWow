...
/// [`labor_market_model::SubmitDeliverableParamsV1`] python binding.
#[pyclass]
pub struct LaborMarketSubmitDeliverableParamsV1(labor_market_model::SubmitDeliverableParamsV1);
impl_py_methods!(LaborMarketSubmitDeliverableParamsV1);

impl FunctionParams for labor_market_model::SubmitDeliverableParamsV1 {
