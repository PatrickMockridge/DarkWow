...
/// [`labor_market_model::ConfirmDeliveryParamsV1`] python binding.
#[pyclass]
pub struct LaborMarketConfirmDeliveryParamsV1(labor_market_model::ConfirmDeliveryParamsV1);
impl_py_methods!(LaborMarketConfirmDeliveryParamsV1);

impl FunctionParams for labor_market_model::ConfirmDeliveryParamsV1 {
