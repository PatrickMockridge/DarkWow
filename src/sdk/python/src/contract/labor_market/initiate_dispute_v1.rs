...
/// [`labor_market_model::InitiateDisputeParamsV1`] python binding.
#[pyclass]
pub struct LaborMarketInitiateDisputeParamsV1(labor_market_model::InitiateDisputeParamsV1);
impl_py_methods!(LaborMarketInitiateDisputeParamsV1);

impl FunctionParams for labor_market_model::InitiateDisputeParamsV1 {
    fn to_pydict(&self, py: Python) -> PyResult<Py<PyDict>> {
        ...
        dict.set_item("disputer_pub_x", format!("{:?}", self.disputer_pub_x))?;
        dict.set_item("disputer_pub_y", format!("{:?}", self.disputer_pub_y))?;
    ...
    fn fmt_pretty(&self, out: &mut String, depth: usize) -> PyResult<()> {
        ...
        writeln!(out, "{prefix}disputer_pub_x: {:?}", self.disputer_pub_x).unwrap();
        writeln!(out, "{prefix}disputer_pub_y: {:?}", self.disputer_pub_y).unwrap();
