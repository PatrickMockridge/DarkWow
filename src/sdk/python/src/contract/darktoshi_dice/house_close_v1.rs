...
/// [`darktoshi_dice_model::HouseCloseParamsV1`] python binding.
#[pyclass]
pub struct DiceHouseCloseParamsV1(darktoshi_dice_model::HouseCloseParamsV1);
impl_py_methods!(DiceHouseCloseParamsV1);

impl FunctionParams for darktoshi_dice_model::HouseCloseParamsV1 {
