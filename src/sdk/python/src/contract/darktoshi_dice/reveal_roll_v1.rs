...
/// [`darktoshi_dice_model::RevealRollParamsV1`] python binding.
#[pyclass]
pub struct DiceRevealRollParamsV1(darktoshi_dice_model::RevealRollParamsV1);
impl_py_methods!(DiceRevealRollParamsV1);

impl FunctionParams for darktoshi_dice_model::RevealRollParamsV1 {
