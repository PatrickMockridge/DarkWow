...
/// [`darktoshi_dice_model::CommitBetParamsV1`] python binding.
#[pyclass]
pub struct DiceCommitBetParamsV1(darktoshi_dice_model::CommitBetParamsV1);
impl_py_methods!(DiceCommitBetParamsV1);

impl FunctionParams for darktoshi_dice_model::CommitBetParamsV1 {
