...
/// [`betting_stake_model::UnstakeParamsV1`] python binding.
#[pyclass]
pub struct BettingStakeUnstakeParamsV1(betting_stake_model::UnstakeParamsV1);
impl_py_methods!(BettingStakeUnstakeParamsV1);

impl FunctionParams for betting_stake_model::UnstakeParamsV1 {
    fn to_pydict(&self, py: Python) -> PyResult<Py<PyDict>> {
        ...
        dict.set_item("original_amount", self.original_amount)?;
    ...
    fn fmt_pretty(&self, out: &mut String, depth: usize) -> PyResult<()> {
        ...
        writeln!(out, "{prefix}original_amount: {}", self.original_amount).unwrap();
