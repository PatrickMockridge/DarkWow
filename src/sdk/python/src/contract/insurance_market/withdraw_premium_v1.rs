...
/// [`insurance_market_model::WithdrawPremiumParamsV1`] python binding.
#[pyclass]
pub struct InsuranceMarketWithdrawPremiumParamsV1(insurance_market_model::WithdrawPremiumParamsV1);
impl_py_methods!(InsuranceMarketWithdrawPremiumParamsV1);

impl FunctionParams for insurance_market_model::WithdrawPremiumParamsV1 {
