...
/// [`insurance_market_model::PurchaseCoverageParamsV1`] python binding.
#[pyclass]
pub struct InsuranceMarketPurchaseCoverageParamsV1(insurance_market_model::PurchaseCoverageParamsV1);
impl_py_methods!(InsuranceMarketPurchaseCoverageParamsV1);

impl FunctionParams for insurance_market_model::PurchaseCoverageParamsV1 {
