...
/// [`insurance_market_model::ResolveClaimWithCapabilityParamsV1`] python binding.
#[pyclass]
pub struct InsuranceMarketResolveClaimWithCapabilityParamsV1(
    insurance_market_model::ResolveClaimWithCapabilityParamsV1,
);
impl_py_methods!(InsuranceMarketResolveClaimWithCapabilityParamsV1);

impl FunctionParams for insurance_market_model::ResolveClaimWithCapabilityParamsV1 {
