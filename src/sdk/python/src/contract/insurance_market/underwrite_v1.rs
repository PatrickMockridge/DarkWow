...
/// [`insurance_market_model::UnderwriteParamsV1`] python binding.
#[pyclass]
pub struct InsuranceMarketUnderwriteParamsV1(insurance_market_model::UnderwriteParamsV1);
impl_py_methods!(InsuranceMarketUnderwriteParamsV1);

impl FunctionParams for insurance_market_model::UnderwriteParamsV1 {
