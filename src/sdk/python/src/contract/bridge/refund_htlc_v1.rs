...
/// [`bridge_model::RefundHtlcParams`] python binding.
#[pyclass]
pub struct BridgeRefundHtlcParamsV1(bridge_model::RefundHtlcParams);
impl_py_methods!(BridgeRefundHtlcParamsV1);

impl FunctionParams for bridge_model::RefundHtlcParams {
