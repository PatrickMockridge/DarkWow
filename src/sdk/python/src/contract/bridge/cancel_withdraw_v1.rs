...
/// [`bridge_model::CancelWithdrawParams`] python binding.
#[pyclass]
pub struct BridgeCancelWithdrawParamsV1(bridge_model::CancelWithdrawParams);
impl_py_methods!(BridgeCancelWithdrawParamsV1);

impl FunctionParams for bridge_model::CancelWithdrawParams {
