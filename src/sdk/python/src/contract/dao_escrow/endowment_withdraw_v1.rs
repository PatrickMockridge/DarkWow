...
/// [`dao_escrow_model::EndowmentWithdrawParamsV1`] python binding.
#[pyclass]
pub struct DaoEscrowEndowmentWithdrawParamsV1(dao_escrow_model::EndowmentWithdrawParamsV1);
impl_py_methods!(DaoEscrowEndowmentWithdrawParamsV1);

impl FunctionParams for dao_escrow_model::EndowmentWithdrawParamsV1 {
