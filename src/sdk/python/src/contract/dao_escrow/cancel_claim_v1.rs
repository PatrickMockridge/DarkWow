...
/// [`dao_escrow_model::CancelClaimParamsV1`] python binding.
#[pyclass]
pub struct DaoEscrowCancelClaimParamsV1(dao_escrow_model::CancelClaimParamsV1);
impl_py_methods!(DaoEscrowCancelClaimParamsV1);

impl FunctionParams for dao_escrow_model::CancelClaimParamsV1 {
