...
/// [`dao_escrow_model::WithdrawParamsV1`] python binding.
#[pyclass]
pub struct DaoEscrowWithdrawParamsV1(dao_escrow_model::WithdrawParamsV1);
impl_py_methods!(DaoEscrowWithdrawParamsV1);

impl FunctionParams for dao_escrow_model::WithdrawParamsV1 {
