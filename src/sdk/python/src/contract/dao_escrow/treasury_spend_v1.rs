...
/// [`dao_escrow_model::TreasurySpendParamsV1`] python binding.
#[pyclass]
pub struct DaoEscrowTreasurySpendParamsV1(dao_escrow_model::TreasurySpendParamsV1);
impl_py_methods!(DaoEscrowTreasurySpendParamsV1);

impl FunctionParams for dao_escrow_model::TreasurySpendParamsV1 {
