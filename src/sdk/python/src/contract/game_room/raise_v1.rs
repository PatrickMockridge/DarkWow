...
/// [`game_room_model::RaiseParamsV1`] python binding.
#[pyclass]
pub struct GameRoomRaiseParamsV1(game_room_model::RaiseParamsV1);
impl_py_methods!(GameRoomRaiseParamsV1);

impl FunctionParams for game_room_model::RaiseParamsV1 {
