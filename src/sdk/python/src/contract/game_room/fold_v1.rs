...
/// [`game_room_model::FoldParamsV1`] python binding.
#[pyclass]
pub struct GameRoomFoldParamsV1(game_room_model::FoldParamsV1);
impl_py_methods!(GameRoomFoldParamsV1);

impl FunctionParams for game_room_model::FoldParamsV1 {
