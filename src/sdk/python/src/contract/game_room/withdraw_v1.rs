...
/// [`game_room_model::WithdrawParamsV1`] python binding.
#[pyclass]
pub struct GameRoomWithdrawParamsV1(game_room_model::WithdrawParamsV1);
impl_py_methods!(GameRoomWithdrawParamsV1);

impl FunctionParams for game_room_model::WithdrawParamsV1 {
