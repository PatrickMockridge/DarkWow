...
/// [`game_room_model::PlaceBetParamsV1`] python binding.
#[pyclass]
pub struct GameRoomPlaceBetParamsV1(game_room_model::PlaceBetParamsV1);
impl_py_methods!(GameRoomPlaceBetParamsV1);

impl FunctionParams for game_room_model::PlaceBetParamsV1 {
    fn to_pydict(&self, py: Python) -> PyResult<Py<PyDict>> {
        ...
        dict.set_item("block_height", format!("{:?}", self.block_height))?;
        Ok(dict.unbind())
    }
    ...
    fn fmt_pretty(&self, out: &mut String, depth: usize) -> PyResult<()> {
        ...
        writeln!(out, "{prefix}block_height: {:?}", self.block_height).unwrap();
        Ok(())
    }
}
