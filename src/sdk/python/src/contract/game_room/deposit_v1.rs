...
/// [`game_room_model::DepositParamsV1`] python binding.
#[pyclass]
pub struct GameRoomDepositParamsV1(game_room_model::DepositParamsV1);
impl_py_methods!(GameRoomDepositParamsV1);

impl FunctionParams for game_room_model::DepositParamsV1 {
