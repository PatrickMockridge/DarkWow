...
/// [`subscription_model::CancelParamsV1`] python binding.
#[pyclass]
pub struct SubscriptionCancelParamsV1(subscription_model::CancelParamsV1);
impl_py_methods!(SubscriptionCancelParamsV1);

impl FunctionParams for subscription_model::CancelParamsV1 {
