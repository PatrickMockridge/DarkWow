...
/// [`roulette_model::HouseCloseParamsV1`] python binding.
#[pyclass]
pub struct RouletteHouseCloseParamsV1(roulette_model::HouseCloseParamsV1);
impl_py_methods!(RouletteHouseCloseParamsV1);

impl FunctionParams for roulette_model::HouseCloseParamsV1 {
