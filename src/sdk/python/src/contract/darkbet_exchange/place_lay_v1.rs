...
/// [`darkbet_exchange_model::PlaceLayParamsV1`] python binding.
#[pyclass]
pub struct DarkbetPlaceLayParamsV1(darkbet_exchange_model::PlaceLayParamsV1);
impl_py_methods!(DarkbetPlaceLayParamsV1);

impl FunctionParams for darkbet_exchange_model::PlaceLayParamsV1 {
