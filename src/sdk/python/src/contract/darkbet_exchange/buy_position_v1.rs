...
/// [`darkbet_exchange_model::BuyPositionParamsV1`] python binding.
#[pyclass]
pub struct DarkbetBuyPositionParamsV1(darkbet_exchange_model::BuyPositionParamsV1);
impl_py_methods!(DarkbetBuyPositionParamsV1);

impl FunctionParams for darkbet_exchange_model::BuyPositionParamsV1 {
    fn to_pydict(&self, py: Python) -> PyResult<Py<PyDict>> {
        ...
        dict.set_item("min_payout", self.min_payout)?;
    ...
    fn fmt_pretty(&self, out: &mut String, depth: usize) -> PyResult<()> {
        ...
        writeln!(out, "{prefix}outcome: {}", self.outcome).unwrap();
        writeln!(out, "{prefix}amount: {}", self.amount).unwrap();
        writeln!(out, "{prefix}min_payout: {}", self.min_payout).unwrap();
