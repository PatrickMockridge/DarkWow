...
/// [`escrow_model::FundEscrowParamsV1`] python binding.
#[pyclass]
pub struct EscrowFundParamsV1(escrow_model::FundEscrowParamsV1);
impl_py_methods!(EscrowFundParamsV1);

impl FunctionParams for escrow_model::FundEscrowParamsV1 {
