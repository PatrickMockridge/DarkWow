...
/// [`pool_stake_model::ClaimFeesParamsV1`] python binding.
#[pyclass]
pub struct PoolStakeClaimFeesParamsV1(pool_stake_model::ClaimFeesParamsV1);
impl_py_methods!(PoolStakeClaimFeesParamsV1);

impl FunctionParams for pool_stake_model::ClaimFeesParamsV1 {
