...
/// [`pool_stake_model::ReleaseCoverageParamsV1`] python binding.
#[pyclass]
pub struct PoolStakeReleaseCoverageParamsV1(pool_stake_model::ReleaseCoverageParamsV1);
impl_py_methods!(PoolStakeReleaseCoverageParamsV1);

impl FunctionParams for pool_stake_model::ReleaseCoverageParamsV1 {
