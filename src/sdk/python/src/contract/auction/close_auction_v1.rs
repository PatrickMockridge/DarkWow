...
/// [`auction_model::CloseAuctionParamsV1`] python binding.
#[pyclass]
pub struct AuctionCloseAuctionParamsV1(auction_model::CloseAuctionParamsV1);
impl_py_methods!(AuctionCloseAuctionParamsV1);

impl FunctionParams for auction_model::CloseAuctionParamsV1 {
