...
/// [`relayer_endowment_model::UpdateConfigParamsV1`] python binding.
#[pyclass]
pub struct RelayerEndowmentUpdateConfigParamsV1(relayer_endowment_model::UpdateConfigParamsV1);
impl_py_methods!(RelayerEndowmentUpdateConfigParamsV1);

impl FunctionParams for relayer_endowment_model::UpdateConfigParamsV1 {
