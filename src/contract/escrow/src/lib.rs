...
pub const ESCROW_CONTRACT_ZKAS_CREATE_NS_V2: &str = "CreateEscrowV2";
pub const ESCROW_CONTRACT_ZKAS_FUND_NS_V2: &str = "FundEscrowV2";
pub const ESCROW_CONTRACT_ZKAS_CLAIM_NS_V2: &str = "ClaimEscrowV2";
pub const ESCROW_CONTRACT_ZKAS_REFUND_NS_V2: &str = "RefundEscrowV2";
pub const ESCROW_CONTRACT_ZKAS_CANCEL_NS_V2: &str = "CancelEscrowV2";
