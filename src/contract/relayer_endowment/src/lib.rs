...
//! DarkWow Relayer Endowment Contract
//!
//! ## Overview
//!
...
pub const RELAYER_ENDOWMENT_MONEY_V3_CONTRACT_ID: &[u8] = b"money_v3_cid";
...
/// Maximum allocations per settle_fees call
pub const RELAYER_ENDOWMENT_MAX_ALLOCATIONS: usize = 100;
