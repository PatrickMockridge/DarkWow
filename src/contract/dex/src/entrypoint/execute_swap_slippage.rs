...
use crate::{
    ...
    DEX_CONTRACT_ZKAS_EXECUTE_SWAP_SLIPPAGE_NS_V2, PROMISSORY_NOTE_CONTRACT_ID_KEY,
};
...
pub(crate) fn dex_execute_swap_slippage_process_instruction_v1(
    ...
    for &child_idx in self_.children_indexes.iter() {
        ...
        if child_call.data[0] != 0x04 {
            msg!("[ExecuteSwapSlippageV1] Error: Expected promissory_note::transfer_v1 (0x04), got 0x{:02x}",
                 child_call.data[0]);
