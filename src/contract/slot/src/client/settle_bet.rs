...
pub struct SettleBetV1CallData {
    ...
    pub position_0: pallas::Base,
    pub position_1: pallas::Base,
    pub position_2: pallas::Base,
    pub match_count: pallas::Base,
    pub payout: u64,
...
impl SettleBetV1CallData {
    pub fn new(
        ...
        Self {
            ...
            blind,
            asset_id,
            position_0: pallas::Base::from(positions[0]),
            position_1: pallas::Base::from(positions[1]),
            position_2: pallas::Base::from(positions[2]),
            match_count: pallas::Base::from(match_count),
            payout,
    ...
    pub fn to_witnesses(&self) -> Vec<Witness> {
        vec![
            ...
            Witness::Base(Value::known(self.position_0)),
            Witness::Base(Value::known(self.position_1)),
            Witness::Base(Value::known(self.position_2)),
            Witness::Base(Value::known(self.match_count)),
