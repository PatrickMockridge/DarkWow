...
impl TestHarness {
    /// Deploy the Oracle WASM contract.
    ...
    /// Create a `Oracle::RegisterOracleV1` transaction.
    ...
    /// Execute a `Oracle::RegisterOracleV1` transaction.
    pub async fn execute_oracle_register_tx(
        &mut self,
        holder: &Holder,
        tx: Transaction,
        _params: &RegisterOracleParamsV1,
        ...
        wallet.add_transaction("oracle::register", tx, block_height).await?;
