...
impl StablecoinHarness {
    ...
    pub fn spawn() -> Self {
        ...
        let liquidate_bin = include_bytes!("../../../stablecoin/proof/liquidate.zk.bin");
        let governance_bin = include_bytes!("../../../stablecoin/proof/governance_report.zk.bin");
        let accrue_bin = include_bytes!("../../../stablecoin/proof/accrue_interest.zk.bin");
        let add_collateral_bin = include_bytes!("../../../stablecoin/proof/add_collateral.zk.bin");
        let remove_collateral_bin = include_bytes!("../../../stablecoin/proof/remove_collateral.zk.bin");
        let repay_stable_bin = include_bytes!("../../../stablecoin/proof/repay_stable.zk.bin");
        let update_config_bin = include_bytes!("../../../stablecoin/proof/update_config.zk.bin");
