 ...
 * Free Software Foundation; either version 3 of the License, or your
...
impl BettingStakeHarness {
    ...
    pub fn spawn() -> Self {
        let init_bin = include_bytes!("../../../betting_stake/proof/init_v1.zk.bin");
        let stake_bin = include_bytes!("../../../betting_stake/proof/stake_v1.zk.bin");
        let unstake_bin = include_bytes!("../../../betting_stake/proof/unstake_v1.zk.bin");
        let claim_bin = include_bytes!("../../../betting_stake/proof/claim_v1.zk.bin");
        let update_risk_bin = include_bytes!("../../../betting_stake/proof/update_risk_v1.zk.bin");
