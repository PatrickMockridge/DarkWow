...
//! Money V3 TokenMintV1 Client API
//!
...
pub struct TokenMintRevealed {
    ...
    /// The token ID commitment (hides token_id)
...
/// Struct holding necessary information to build a `MoneyV3::TokenMintV1` contract call.
...
impl TokenMintCallBuilder {
    ...
    pub fn build(self) -> Result<TokenMintCallDebris> {
        debug!(target: "contract::money_v3::client::token_mint", "Building MoneyV3::TokenMintV1 contract call");
        ...
        // Value commitment (Poseidon hash)
