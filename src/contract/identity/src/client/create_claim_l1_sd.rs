...
/// CreateClaimV1L1V2 circuit public inputs
#[derive(Debug, Clone)]
pub struct CreateClaimL1V2PublicInputs {
...
/// Input data for create_claim_l1_v2 proof generation
#[derive(Debug, Clone)]
pub struct CreateClaimL1V2CallData {
...
/// Create a CreateClaimL1V2 ZK proof
pub fn create_claim_l1_v2_proof(
    zkbin: &ZkBinary,
    pk: &ProvingKey,
    input: &CreateClaimL1V2CallData,
) -> Result<(Proof, CreateClaimL1V2PublicInputs)> {
