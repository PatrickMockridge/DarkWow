...
fn get_metadata(cid: ContractId, ix: &[u8]) -> ContractResult {
    ...
    let metadata = match func {
        ...
        MoneyFunction::GenesisMintV2 => money_genesis_mint_get_metadata_v1(cid, call_idx, calls)?,
        MoneyFunction::PoWRewardV2 => money_pow_reward_get_metadata_v1(cid, call_idx, calls)?,
        MoneyFunction::TransferV2 => money_transfer_get_metadata_v1(cid, call_idx, calls)?,
        MoneyFunction::OtcSwapV2 => money_otcswap_get_metadata_v1(cid, call_idx, calls)?,
        MoneyFunction::AuthTokenMintV2 => {
            money_auth_token_mint_get_metadata_v1(cid, call_idx, calls)?
        }
        MoneyFunction::AuthTokenFreezeV2 => {
            money_auth_token_freeze_get_metadata_v1(cid, call_idx, calls)?
        }
        MoneyFunction::TokenMintV2 => money_token_mint_get_metadata_v1(cid, call_idx, calls)?,
        MoneyFunction::BurnV2 => money_burn_get_metadata_v1(cid, call_idx, calls)?,
    };
...
fn process_instruction(cid: ContractId, ix: &[u8]) -> ContractResult {
    ...
    let update_data = match func {
        ...
        MoneyFunction::GenesisMintV2 => {
            money_genesis_mint_process_instruction_v1(cid, call_idx, calls)?
        }
        MoneyFunction::PoWRewardV2 => {
            money_pow_reward_process_instruction_v1(cid, call_idx, calls)?
        }
        MoneyFunction::TransferV2 => money_transfer_process_instruction_v1(cid, call_idx, calls)?,
        MoneyFunction::OtcSwapV2 => money_otcswap_process_instruction_v1(cid, call_idx, calls)?,
        MoneyFunction::AuthTokenMintV2 => {
        ...
        MoneyFunction::TokenMintV2 => {
            money_token_mint_process_instruction_v1(cid, call_idx, calls)?
        }
        MoneyFunction::BurnV2 => money_burn_process_instruction_v1(cid, call_idx, calls)?,
    };
