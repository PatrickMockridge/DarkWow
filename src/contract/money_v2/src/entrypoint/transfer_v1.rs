...
use crate::{
    ...
    MONEY_CONTRACT_NULLIFIER_ROOTS_TREE, MONEY_CONTRACT_ZKAS_BURN_NS_V2,
    MONEY_CONTRACT_ZKAS_MINT_NS_V2,
};
...
pub(crate) fn money_transfer_get_metadata_v1(
    ...
    for input in &params.inputs {
        ...
        zk_public_inputs.push((
            MONEY_CONTRACT_ZKAS_BURN_NS_V2.to_string(),
            vec![
    ...
    for output in &params.outputs {
        ...
        zk_public_inputs.push((
            MONEY_CONTRACT_ZKAS_MINT_NS_V2.to_string(),
