...
pub const AUCTION_CONTRACT_ZKAS_CREATE_NS_V2: &str = "CreateAuctionV2";
pub const AUCTION_CONTRACT_ZKAS_PLACE_BID_NS_V2: &str = "PlaceBidV2";
pub const AUCTION_CONTRACT_ZKAS_CLOSE_NS_V2: &str = "CloseAuctionV2";
pub const AUCTION_CONTRACT_ZKAS_CLAIM_WINNINGS_NS_V2: &str = "ClaimWinningsV2";
pub const AUCTION_CONTRACT_ZKAS_SETTLE_NS_V2: &str = "SettleAuctionV2";
pub const AUCTION_CONTRACT_ZKAS_REFUND_BID_NS_V2: &str = "RefundBidV2";