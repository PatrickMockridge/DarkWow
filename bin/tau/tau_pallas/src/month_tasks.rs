...
impl MonthTasks {
    ...
    pub fn objects(&self, dataset_path: &Path) -> TauPallasResult<Vec<TaskInfo>> {
    ...
    pub fn save(&self, dataset_path: &Path) -> TauPallasResult<()> {
    ...
    fn create(date: &Timestamp, dataset_path: &Path) -> TauPallasResult<Self> {
    ...
    pub fn load_or_create(date: Option<&Timestamp>, dataset_path: &Path) -> TauPallasResult<Self> {
...
mod tests {
    ...
    #[test]
    fn load_and_save_tasks() -> TauPallasResult<()> {
